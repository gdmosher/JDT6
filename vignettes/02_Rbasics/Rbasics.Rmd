...
<title>Introduction to R | Jekyll theme for documentation</title>
...
<div id="toc"></div>
    ...
    <a target="_blank" href="https://github.com/tomjohnson1492/documentation-theme-jekyll/blob/gh-pages/_pages//_pages//vignettes02_RbasicsRbasics.Rmd.md" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
