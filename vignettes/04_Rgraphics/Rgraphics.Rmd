...
<title>R Graphics | Jekyll theme for documentation</title>
...
var body = "I have some feedback about the R Graphics page: ";
                ...
                <li>
                    ...
                    <script type="text/javascript">
                            SimpleJekyllSearch.init({
                                ...
                                searchResultTemplate: '<li><a href="{url}" title="R Graphics">{title}</a></li>',
...
<script>$("li.active").parents('li').toggleClass("active");</script>
   ...
   <h1 class="post-title-main">R Graphics</h1>
</div>
...
<div id="toc"></div>
    ...
    <a target="_blank" href="https://github.com/tomjohnson1492/documentation-theme-jekyll/blob/gh-pages/_pages//_pages//vignettes04_RgraphicsRgraphics.Rmd.md" class="btn btn-default githubEditButton" role="button"><i class="fa fa-github fa-lg"></i> Edit me</a>
